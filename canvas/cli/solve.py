...
import numpy as np
import os
from canvas.routing import TACCLRouting
from canvas.heuristic_ordering import HeuristicOrderer
from canvas.scheduler import TACCLScheduler
from canvas.reduce_scheduler import TACCLRevScheduler
from .known_collectives import KnownCollectives
from .known_topologies import KnownTopologies
from .common import *
from canvas.semantic.search import *
...
def make_handle_search_comm_sketch(cmd_parsers):
    ...
    # return handle
        ...
        # 保存json文件
        with open("Allreduce_algo.json", 'w') as f:
